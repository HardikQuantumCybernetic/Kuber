    ...
    home: `
        <section class="banner">
            <div class="banner-text">
                <h1 class="banner-title">Welcome to Kuer Vegetarian Hotel</h1>
                <p class="banner-desc">
...
const menuData = [
    ...
    {
        name: "Chaat Platter",
        img: "assets/chaat-platter.jpg",
        price: 300,
        ingredients: "Variety of chaat items, chutneys, spices",
        rating: 4.7
    },
    {
        name: "Vegetable Manchurian",
        img: "assets/vegetable-manchurian.jpg",
        price: 250,
        ingredients: "Mixed vegetables, soy sauce, spices",
        rating: 4.4
    },
    {
        name: "Kheer",
...
function navigateTo(page) {
    ...
    setTimeout(() => {
        ...
        // If menu page, populate dishes
        if (page === 'menu') renderMenu();
        // If contact page, setup contact form
...
function renderMenu(filteredMenu) {
    ...
    // Always show all items if no filter (empty string)
        ...
        menuList.innerHTML += `
            <div class="menu-card">
                ...
                <div class="menu-info">
                    ...
                    <div class="menu-rating">${renderStars(dish.rating)} ${dish.rating.toFixed(1)}/5</div>
                </div>
            </div>
        `;
    });
